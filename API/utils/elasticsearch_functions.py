...
class ElasticSearch(BaseModel):
    ...
    def search_by_text_query(self, 
                             query: str, 
                             fields: Optional[Dict[str,int]] = {"tags":1, "Title":2}, 
        ...
        return es.search(index=INDEX_NAME, body=q, size=size, _source=SOURCE_NO_VEC, from_ = from_)
    ...
    def search_by_image_query(self, 
        ...
        return es.search(index=INDEX_NAME, body=query, size=size, _source=SOURCE_NO_VEC, from_=from_)
